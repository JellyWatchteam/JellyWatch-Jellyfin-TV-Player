...
**The most complete Jellyfin and Emby player — for Android TV, mobile and tablet.**

Native Jetpack Compose app. One app for your TV, phone and tablet.
...
JellyWatch Player turns your Jellyfin or Emby server into a real home cinema on Android TV, Google TV, Fire TV — and a polished streaming app on your Android phone and tablet. A fast, consistent interface designed for every screen, with the features no other Jellyfin or Emby client ships together in one app.

Works on NVIDIA Shield, Chromecast with Google TV, Sony Bravia, Xiaomi Mi Box, Amazon Fire TV, and any device running Android 8.0 or above.
...
| Feature | Details |
|---|---|
| **Still Watching** | After several consecutive episodes without interaction, a dialog asks if you are still there. Pauses playback if you do not respond. Configurable threshold (2-5 episodes). |
...
| Feature | Details |
|---|---|
| **Music in the car** | When your phone is connected to a car running Android Auto, JellyWatch Player appears in the media apps list. Browse and play your Jellyfin or Emby music library from the car screen. |
...
| **Voice search** | "Hey Google, play [artist] on JellyWatch Player". Falls back to suggested tracks when no match is found. |
...
- Built-in EPUB reader for Jellyfin book libraries (dark, light and sepia themes, D-pad / touch navigation)
...
- Android 8.0 or above (TV, phone and tablet)
...
**Google Play** (Android TV, Google TV, Android phone and tablet)

Search for *JellyWatch Player* on Google Play or use the direct link:
...
**JellyWatch** is the monitoring and management app for your Jellyfin server. Use it on your phone to track active sessions, manage users, view analytics and control your server. Available on Google Play.
